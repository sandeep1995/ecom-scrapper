...
module.exports = {
    flipkart: (url, pid) => {
        ...
        return execFile('casperjs', ['routes/ecommerce/flipkart.js', url.split("&")[0]])
    ...
    amazon: (url, pid) => {
        ...
        return execFile('casperjs', ['routes/ecommerce/amazon.js', url.split("ref")[0]])
            .then(function(result) {
                var stdout = result.stdout;
                var stderr = result.stderr;
                if (stderr) {
    ...
    snapdeal: (url, pid) => {
        ...
        return execFile('casperjs', ['routes/ecommerce/snapdeal.js', url])
            .then(function(result) {
                var stdout = result.stdout;
                var stderr = result.stderr;
                return stdout;
    ...
    myntra: (url, pid) => {
        ...
        return execFile('casperjs', ['routes/ecommerce/myntra.js', url])
            .then(function(result) {
                var stdout = result.stdout;
                var stderr = result.stderr;
                if (stderr) {
    ...
    ebay: (url, pid) => {
        ...
        return execFile('casperjs', ['routes/ecommerce/ebay.js', url])
            .then(function(result) {
                var stdout = result.stdout;
                var stderr = result.stderr;
                if (stderr) {
